...
const ADJECTIVES = [
    ...
    "Sit-down dinners",
    "Feminist literature ",
    "The pain women experience every month",
    "I have no female friends but I like the idea.",
    "Star Wars",
    "Star Wars is my Bible.",
    "★",
    "I pledge allegiance to the swag",
    "Labubu quality control tester.",
    "Shiny",
    ...
    "Priest",
    "Elderly",
    "X (formerly know as Twitter) fact-checker",
    "Lawn mower enthusiast",
    "My John Deere is dear to me.",
    "Fortnite",
    "I order all of my sandwiches with mayonnaise.",
    "Trend starter.",
    "Professional Mine Sweeper",
    "Handshakes",
    ...
    "Nerd",
    "99 Woodcutting.",
    "Sometimes I get my fingers caught in my shoe laces.",
    "I still don't know Victoria's secret.",
    "Uber Driver.",
    ...
    "Green",
    "Orange",
    "Currently studying for the prostate exam.",
    "Hannah Montana",
    "Miley Cyrus",
    "I like to run out my door with toast in my mouth.",
    "Time-traveller",
    "Silly Goose",
    "Three time winner of the Tic-tac-toe world championship.",
    "Extreme Couponer",
    "President of the Brody Fan Club.",
    "Classical music",
    "Talus Dome",
    "Your dad's music",
    "Sports ball",
    ...
    "Looking mysterious",
    "Balding",
    "I will be bald by the age of 35.",
    "Ice cream",
    "I win at monopoly.",
    "Brussels sprouts",
    "Power Line enthusiast.",
    "Only a picture could frame me for my good looks.",
    "100% fail rate for Joe mama joke.",
    "Still use my fingers to count.",
    "Customer Service Representative.",
    "Cried when watching Hot Frosty.",
    "Hacker",
    "Spam Caller.",
    "I'm the one who is one caller ahead of you.",
    "Big Brain",
    "Golf",
    ...
    "Redstone",
    "Bluestone",
    "De-centralized data storage",
    "Cows",
    "Conductor",
    "I've had the same email since Gr.5.",
    "Heart Passion",
    "IEEE standards",
    "Protocol 7",
    "Clubbing",
    "My mom's opinion is all that matters.",
    "First in food line ",
    "New yorker",
    "You look exactly like my first wife.",
    "Whats the difference between gas and diesel?",
    ...
    "Swimming",
    "Drowning",
    "I leave the cookie in the milk until the bubbles stop.",
    "Movies",
    "Cuddles",
    "Dog Whisperer.",
    "Buying GF",
    "Newest Shark on Shark Tank.",
    "Make-up Tester.",
    "Adrien",
    "Project Manager",
    "Girl Boss",
    "Loan Shark",
    "Genuine Fairy",
    "Even the milk has a date for the 14th.",
    "Yappaholic.",
    "Cyborg",
    "uɐᴉlɐɹʇsnɐ",
    "����",
    "Professional Waifu",
    "Currently working at ██████████ within the ██████ division.",
    "3D Printed",
    "Low balling on marketplace",
    "Friday nights are for my WWII model collection.",
    "Stepping on Lego to feel something again.",
    "Crocodile Hunter.",
    "Space",
    "Loud noises",
    "Charlie Sheen",
    ...
    "Bull Runner.",
    "Glowing",
    "You'll find me walking my pitbull without a leash everyday.",
    "Manager at Weenie Hut Jr's",
    "Fry Cook.",
    "Schizophrenic",
    "Cowboy",
    "If it came down to it I would do CPR.",
]
