...
const ProfileCard = ({ profile, dragHandler, style }) => {
    ...
    // Dynamic font size for long names matches
    const nameLength = (profile.name || "Brody").length
    // Base size 2.2rem, shrink down to 1.2rem for very long names
    const nameFontSize = nameLength > 25 ? "1.3rem" : nameLength > 15 ? "1.6rem" : "2.2rem"
        ...
        >
            ...
            <div className="card-content-overlay">
                <div className="header-row">
                    <h2 className="name" style={{ fontSize: nameFontSize }}>{profile.name || "Brody"}, {profile.age || 24}</h2>
                </div>
